...
'''
Full problem description: https://projecteuler.net/problem=11

We're given a 20x20 grid. 
The task is to find the greatest product of four adjacent numbers in the same direction (up, down, left, right, or diagonally).
'''
...
def realGrid():
    my_grid = "08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08 \
